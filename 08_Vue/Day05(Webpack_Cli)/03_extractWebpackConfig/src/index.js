...
// 02 ES6模块化规范: import from 导入
import {name, age, height} from "./js/info";
console.log(name, age, height);

// 03 依赖css, 以模块化的方式引入即可
...
// 打包时无法运行, 添加如下属性到module.export{}中; 因为vue有complier和run-only两个版本
// resolve: {
//   alias: {
...
// } 
import Vue from "vue" 
import app from "./vue/app.vue"      //自定义export default{}的内容的名字   
