...
const UglifyjsWebpackPlugin = require("uglifyjs-webpack-plugin");    //压缩JS代码
...
module.exports = {
  ...
  plugins: [
    ...
    // new UglifyjsWebpackPlugin()                           //压缩JS文件; 开发阶段不需要; 打包需要
  ],
  // devServer: {                                         //打包不需要这个, 开发需要
  //   contentBase: "./dist",
  //   inline: true             //是否需要实时监听, true表示实时监听
  // }
}